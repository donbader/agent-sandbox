...
- **static-header/stx-llm-gateway** — gateway intercepts requests to `agent-gateway.stx-ai.net` and injects your real API key via MITM. The agent only sees a dummy bearer token.
