...
Feature plugins are fetched from GitHub Releases as part of the core tarball. For local development, plugins in `core/plugins/` are packaged by release workflow on `v*` tag push.
